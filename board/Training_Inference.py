...
def stage_acquisition_times(split_points, T_window):
...
def read_configuration_return_results(l, T_window, window_len, fs_base, dataset_name, num_exits, proportions, th_list, sensor_on, sensor_sleep): # proportions here are the data%
    ...
    acq_times = stage_acquisition_times(proportions, T_window)
    # ***************************************************************************
